...
// node_modules/@mui/joy/node_modules/@floating-ui/react-dom/dist/floating-ui.react-dom.mjs
...
var useUtilityClasses23 = (ownerState) => {
  ...
  const slots = {
    root: ["root", determinate && "determinate", color && `color${capitalize(color)}`, variant && `variant${capitalize(variant)}`, size2 && `size${capitalize(size2)}`],
    svg: ["svg"],
    track: ["track"],
    progress: ["progress"]
  };
