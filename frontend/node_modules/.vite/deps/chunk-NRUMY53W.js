...
var _excluded8 = ["absolute", "children", "className", "component", "flexItem", "light", "orientation", "role", "textAlign", "variant"];
...
var _excluded12 = ["ampm", "timeStep", "autoFocus", "components", "componentsProps", "slots", "slotProps", "value", "defaultValue", "referenceDate", "disableIgnoringDatePartForTimeValidation", "maxTime", "minTime", "disableFuture", "disablePast", "minutesStep", "shouldDisableClock", "shouldDisableTime", "onChange", "view", "openTo", "onViewChange", "focusedView", "onFocusedViewChange", "className", "disabled", "readOnly", "views", "skipDisabled", "timezone"];
...
var DigitalClock = React18.forwardRef(function DigitalClock2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(DigitalClockRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState
  }, other, {
    children: (0, import_jsx_runtime18.jsx)(DigitalClockList, {
      ...
      children: timeOptions.map((option) => {
        ...
        return (0, import_jsx_runtime18.jsx)(ClockItem, _extends({
...
true ? DigitalClock.propTypes = {
   ...
   * Controlled focused view.
   */
  focusedView: import_prop_types7.default.oneOf(["hours"]),
  /**
   * Maximal selectable time.
   * The date part of the object will be ignored unless `props.disableIgnoringDatePartForTimeValidation === true`.
   */
   ...
   * Must be a valid option from `views` list.
   */
  openTo: import_prop_types7.default.oneOf(["hours"]),
  /**
   * If `true`, the picker views and text field are read-only.
   * @default false
   */
   ...
   * @default 30
   */
  timeStep: import_prop_types7.default.number,
  /**
   * Choose which timezone to use for the value.
   * Example: "default", "system", "UTC", "America/New_York".
   * If you pass values from other timezones to some props, they will be converted to this timezone before being used.
   ...
   * Must be a valid option from `views` list.
   */
  view: import_prop_types7.default.oneOf(["hours"]),
  /**
   * Available views.
   */
  views: import_prop_types7.default.arrayOf(import_prop_types7.default.oneOf(["hours"]))
} : void 0;
...
var _excluded13 = ["autoFocus", "onChange", "className", "disabled", "readOnly", "items", "active", "slots", "slotProps", "skipDisabled"];
...
var MultiSectionDigitalClockSection = React19.forwardRef(function MultiSectionDigitalClockSection2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsx)(MultiSectionDigitalClockSectionRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    ...
    children: items.map((option) => {
      ...
      return (0, import_jsx_runtime19.jsx)(DigitalClockSectionItem, _extends({
...
var MultiSectionDigitalClock = React20.forwardRef(function MultiSectionDigitalClock2(inProps, ref) {
  ...
  return (0, import_jsx_runtime20.jsx)(MultiSectionDigitalClockRoot, _extends({
    ref,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "group"
  }, other, {
    children: Object.entries(viewTimeOptions).map(([timeView, viewOptions]) => (0, import_jsx_runtime20.jsx)(MultiSectionDigitalClockSection, {
...
true ? MultiSectionDigitalClock.propTypes = {
   ...
   * Controlled focused view.
   */
  focusedView: import_prop_types8.default.oneOf(["hours", "meridiem", "minutes", "seconds"]),
  /**
   * Maximal selectable time.
   * The date part of the object will be ignored unless `props.disableIgnoringDatePartForTimeValidation === true`.
   */
   ...
   * Available views.
   */
  views: import_prop_types8.default.arrayOf(import_prop_types8.default.oneOf(["hours", "meridiem", "minutes", "seconds"]).isRequired)
} : void 0;
...
var renderTimeViewClock = ({
  ...
  timezone
}) => (0, import_jsx_runtime21.jsx)(TimeClock, {
  view,
  onViewChange,
...
var renderDigitalClockTimeView = ({
  ...
  skipDisabled,
  timezone
}) => (0, import_jsx_runtime21.jsx)(DigitalClock, {
  view,
  onViewChange,
  focusedView,
  onFocusedViewChange,
...
var renderMultiSectionDigitalClockTimeView = ({
  ...
  skipDisabled,
  timezone
}) => (0, import_jsx_runtime21.jsx)(MultiSectionDigitalClock, {
  view,
  onViewChange,
  focusedView,
  onFocusedViewChange,
...
//# sourceMappingURL=chunk-NRUMY53W.js.map
